...
const argOptions = [
    ...
    { name: 'length', alias: 't', type: Number, defaultOption: 18000 },
    { name: 'interval', alias: 'i', type: Number, defaultOption: 300 },
...
const length = cliOptions.ticks ? cliOptions.ticks : 3600;
const interval = cliOptions.tickInterval ? cliOptions.tickInterval : 300;
...
Factory_1.Factory.initialize({
    ...
    // lets make a trial to run now with our params...
    ...
    Logging_1.Logging.log('info', `Trial ${trial.id} built!`);
}).catch((e) => {
    console.error(e);
});
