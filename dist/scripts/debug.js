...
const TrialSource_1 = require("../src/TrialSource");
dotenv.config();
...
Factory_1.Factory.initialize({
    ...
    let source = new TrialSource_1.SourceBlueprint(bp);
    yield source.hashFinished;
...
})).then((t) => __awaiter(void 0, void 0, void 0, function* () {
    let results = yield Factory_1.Factory.analyzeTrial(t);
